...
export default async function Home() {
  ...
  return (
    <>
      <Hero 
        title={homepageData?.heroTitle || "The Art of the Mediterranean"}
        subtitle={homepageData?.heroSubtitle || "Handpicked villas with private pools in beautiful destinations"}
      />
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-serif text-gray-900 mb-4 font-light">
              {homepageData?.featuredVillasTitle || "Carefully Chosen Villas"}
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              {homepageData?.featuredVillasDescription || "We personally visit every property, know every location, and care deeply about matching people with the holiday that's right for them"}
            </p>
          </div>
          <FeaturedVillas />
        </div>
